...
<form class="wrap" action="loginAf.do" id="frm" method="post">
	<div class="wrap">
		<div class="login">
			<!-- #21# 로고 추가 및 <h2>Login css 수정 -->
			<div>
				<img class="logo" src="image/movieview.png">
			</div>
			<br>
			<h2>Login</h2>
				...
				<div class="submit">
					<button class="btn btn-outline-secondary" type="button" onclick="login()">로그인</button>
				</div>
		</div>
	</div>
</form>
